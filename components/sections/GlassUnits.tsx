      ...
      <div className="inner">
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {GLASS_UNITS.map((g) => (
            <div
              key={g}
              className="flex min-h-[200px] items-center gap-4 rounded-lg border border-[#ECECEC] bg-white p-5 shadow-[0_10px_28px_-26px_rgba(15,15,15,.3)] transition-[border-color,box-shadow,transform] duration-200 hover:-translate-y-0.5 hover:border-[#D8D8D8] hover:shadow-[0_14px_30px_-24px_rgba(15,15,15,.34)]"
            >
              <GlassThumb k={g} />
